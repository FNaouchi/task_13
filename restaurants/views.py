...
def restaurant_favorite(request, restaurant_id):
    ...
    favorite_obj, created = FavoriteRestaurant.objects.get_or_create(restaurant=restaurant_obj, user=request.user)
    if created:
        action = "favorite"
    else:
        action = "unfavorite"
...
def favorite_restaurants(request):
    ...
    my_favorite =  FavoriteRestaurant.objects.filter(user=request.user)
    context = {
...
def restaurant_list(request):
    ...
    for favorite in FavoriteRestaurant.objects.filter(user=request.user):
        my_favorite.append(favorite.restaurant.id)
    context = {
        "my_favorite":my_favorite,
